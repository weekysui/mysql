...
select last_name last_name, count(*) num from actor group by last_name having num > 2;
...
update actor set first_name = case first_name when 'HARPO' then 'GROUCHO' when 'GROUCHO' then 'MUCHO GROUCHO'  else first_name end;
